...
<body class="container">
    ...
    <section class="view">
        ...
        $stmt = $cnn->query("SELECT * FROM gallery");

        //affichage des résultats
        while ($row = $stmt->fetch()) {
            echo "<h2>" . $row['gallery_title_en'] . "</h2>";
            echo "<p>" . $row['gallery_description_en'] . "</p>";
            echo "<img src='" . $row['gallery_img'] . "'alt='". $row['gallery_img_alt_en'] . "'>";
            echo "<img src='" . $row['gallery_img'] . "'alt='". $row['gallery_img_alt_pt'] . "'>";
            echo "<h2>" . $row['gallery_title_pt'] . "</h2>";
            echo "<p>" . $row['gallery_description_pt'] . "</p>";
        }
        ?>
    </section>
